<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="Apple_Store_System.Payment" %>
...
<script type="text/javascript" language="javascript">
    ...
    function formValidator() {
        ...
        var bill_id = document.getElementById("bill_id");
        var pay_date = document.getElementById("pay_date");
        var cart_amt = document.getElementById("cart_amt");
        var card_no = document.getElementById("card_no");


        // Check each input in the order that it appears in the form!
        if (notEmpty(bill_id, "bill id Must be given") && isNumeric(bill_id, "Please enter only number")) {
                if (notEmpty(card_no, "card_no Must be given") && isNumeric(card_no, "Please enter only number")) {
          ...
          <form id="form1" runat="server" class="php-email-form">
            <div class="row">
              <div class="form-group col-md-6">
                Payment ID
                <asp:TextBox ID="pay_id" class="form-control" runat="server" placeholder="ID" Enabled="False"></asp:TextBox>
              </div>
            ...
            <div class="row">
              <div class="form-group col-md-6">
                Payment Date
                <asp:TextBox ID="pay_date" class="form-control" runat="server" placeholder="Date" Enabled="False"></asp:TextBox>
              </div>
              <div class="form-group col-md-6">
                Cart Amount
                <asp:TextBox ID="cart_amt" class="form-control" runat="server" placeholder="Amount" Enabled="False"></asp:TextBox>
              </div>
             </div>
            ...
            <div class="row">
              <div class="form-group col-md-6">
                Card Number
                <asp:TextBox ID="card_no" class="form-control" runat="server" 
