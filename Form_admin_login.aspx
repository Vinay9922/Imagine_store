<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_admin_login.aspx.cs" Inherits="Apple_Store_System.Form_admin_login" %>
...
<script type="text/javascript" language="javascript">
    ...
    function formValidator() {
        ...
        if (notEmpty(username, "username Must be given") && isAlphabet(username, "Please enter only letters for your name")) {
            if (notEmpty(password, "password Must be given") && isNumeric(password, "please enter only numbers"))  {
                            return true;
                        }
                    }
     ...
     <div class="form">
          <form id="form1" runat="server" class="php-email-form">
              ...
              <div class="form-group col-md-10">
                  ...
                  <div class="form-group col-md-10">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btn_login" runat="server" onclick="Unnamed1_Click" OnClientClick="return formValidator()"
                        Text="Login" Width="74px" />
                        </div>
                        <div class="form-group col-md-2">
                        </div>
                   </div>
