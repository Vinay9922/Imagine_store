<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customerdashboardform.aspx.cs" Inherits="Apple_Store_System.customer_dashboard_form" %>
        ...
        <div class="col-xl-11 d-flex align-items-center justify-content-between">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li><asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/Customer_Logout.aspx">LogOut</asp:HyperLink></li>
            </ul>
  ...
  <!-- ======= Breadcrumbs ======= -->
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          <li><asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Index_page.aspx" >Home /</asp:HyperLink></li>
          <li<asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/search/main_search.aspx">Main Search</asp:HyperLink></a></li>
        </ol>
...
<section id="contact" class="section-bg_one" style="margin-top:50px;">
    ...
    <div class="row">
              <div class="form-group col-md-3">
                    <asp:Button ID="btn_update_info" runat="server" Text="update info" onclick="btn_update_info_Click" />
                </div>

                <div class="form-group col-md-3">
                    <asp:Button ID="btn_payment" runat="server" onclick="btn_payment_Click" Text="payment" />
                </div>

                <div class="form-group col-md-3">
                    <asp:Button ID="btn_customer_wise_bill" runat="server" Text="Customer wise Bill" onclick="btn_customer_wise_bill_Click" />
                </div>

                <div class="form-group col-md-3">
                    <asp:Button ID="btn_customer_wise_order" runat="server" Text="Customer wise Order" />
                </div>
