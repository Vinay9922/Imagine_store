<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main_search.aspx.cs" Inherits="Apple_Store_System.search.main_search" %>
      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-xl-11 d-flex align-items-center justify-content-between">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              <li><asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Index_page.aspx">Home</asp:HyperLink></li>
            </ul>
    ...
    <div class="form">
          <form id="form1" runat="server" class="php-email-form">
             ...
             <div class="form-group col-md-4">
                ...
                <asp:Button ID="btn_search_mobile" runat="server" Text="Search Mobile" 
                    onclick="btn_search_mobile_Click" />
        </div>
        <div class="form-group col-md-4">

                <asp:Button ID="btn_accessories" runat="server" Text="Accessories" 
                    onclick="btn_accessories_Click" />
                    </div>
                    <div class="form-group col-md-4">

            <asp:Button ID="btn_show_cart" runat="server" onclick="btn_show_cart_Click" 
                    Text="Show Cart" />
        </div>
        </div>
    <div>
