...
namespace Apple_Store_System.search
{
    ...
    public partial class search_mobile : System.Web.UI.Page
    {
        SqlConnection cn;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cn.Open();
                 ...
                 cmd = new SqlCommand("SELECT * FROM Mobile_Master", cn);
     ...
     PlaceHolder1.Controls.Add(new LiteralControl("<a href=Search_mobile_details.aspx?ID=" + dr[0].ToString() + "><img src='../photo/" + dr[8].ToString() + "' height=150 width=150 ></img></a><br>"));
     ...
     PlaceHolder1.Controls.Add(new LiteralControl("<font color=orange size=4>" + dr[2].ToString() + "/-</font>"));
