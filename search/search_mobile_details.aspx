<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="search_mobile_details.aspx.cs" Inherits="Apple_Store_System.search.search_mobile_details" %>
    ...
    <section id="contact" class="section-bg_one" style="margin-top:50px;">
      ...
      <div class="form">
        ...
        <asp:PlaceHolder ID="PlaceHolder1" runat="server"></asp:PlaceHolder>
                  ...
                  <br />
                  <asp:Button ID="add_cart" runat="server" onclick="add_cart_Click" 
                      Text="Add To Cart" />
        </div>
        </div>
