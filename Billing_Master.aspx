<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Billing_Master.aspx.cs" Inherits="Apple_Store_System.Billing_Master" %>
...
<script type="text/javascript" language="javascript">
    ...
    function formValidator() {
        ...
        var grandtot = document.getElementById("grandtot");


        // Check each input in the order that it appears in the form!
        if (notEmpty(cust_id, "cust_id Must be given") && isNumeric(cust_id, "Please enter a only numbers")) {
            if (notEmpty(total, "total Must be given") && isNumeric(total, "Please enter a only numbers")) {
                if (notEmpty(gst, "gst Must be given") && isNumeric(gst, "Please enter a only numbers")) {
                    if (notEmpty(grandtot, "grandtot Must be given") && isNumeric(grandtot, "Please enter a only numbers")) {
          ...
          <form id="form2" runat="server" class="php-email-form">
            <div class="row">
              <div class="form-group col-md-6">
                ...
                Billing ID
                <asp:TextBox ID="bill_id" class="form-control" runat="server" placeholder="ID" Enabled="False"></asp:TextBox>
              </div>
               <div class="form-group col-md-6">
                Customer ID
                <asp:TextBox ID="cust_id" class="form-control" runat="server" placeholder="ID" Enabled="False"></asp:TextBox>
               </div>
               </div>
               ...
               <div class="row">
                <div class="form-group col-md-6">
                Date
                <asp:TextBox ID="date" class="form-control" runat="server" placeholder="Date" Enabled="False"></asp:TextBox>
                </div>
                  <div class="form-group col-md-6">
                Total
                <asp:TextBox ID="total" class="form-control" runat="server" placeholder="Total" Enabled="False"></asp:TextBox>
                   </div>
                </div>
                ...
                <div class="row">
                 <div class="form-group col-md-6">
                GST
                <asp:TextBox ID="gst" class="form-control" runat="server" placeholder="GST" Enabled="False"></asp:TextBox>
                 </div>
                  <div class="form-group col-md-6">
                Grand Total
                <asp:TextBox ID="grandtot" class="form-control" runat="server" placeholder="Grand Total" Enabled="False"></asp:TextBox>
                   </div>
                </div>
                ...
                <asp:Button ID="btn_new" runat="server" onclick="btn_new_Click" Text="New" />
                 ...
                 <div class="form-group col-md-3">
                <asp:Button ID="btn_save" runat="server" Enabled="False" OnClientClick="return formValidator()" onclick="btn_save_Click" Text="Save" />
                 </div>
